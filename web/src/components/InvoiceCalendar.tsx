  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-4 px-5 py-4 md:px-6">
        <div>
          <h2 id="calendar-heading" className="text-sm font-medium text-ink-900">
        ...
        <div className="ml-auto flex items-center gap-4">
          <ul className="hidden items-center gap-4 text-xs text-ink-500 sm:flex">
        ...
        <>
          <div className="grid grid-cols-7 border-y border-line bg-canvas">
            {weekdays.map((day) => (
              <div
                key={day}
                className="px-2 py-2 text-center text-[11px] font-medium uppercase tracking-wide text-ink-400"
              >
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {entries.length > 2 && (
                      <span className="tnum text-[10px] text-ink-400">{entries.length}</span>
                    )}
                  </div>
                  ...
                  <ul className="mt-1.5 space-y-1">
                    {entries.slice(0, 2).map((entry) => (
                      ...
                      >
                        ...
                        <span className="tnum hidden min-w-0 truncate text-[11px] text-ink-700 lg:block">
          ...
          <p className="px-5 py-3 text-xs text-ink-400 md:px-6">
